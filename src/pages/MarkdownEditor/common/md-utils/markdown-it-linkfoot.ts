...
function renderFootnoteAnchorName(tokens: Token[], idx: number, options: MarkdownIt.Options, env: any) {
...
function renderFootnoteWord(tokens: Token[], idx: number) {
  return '<span class="footnote-word">' + tokens[idx].content + "</span>";
}

function renderFootnoteRef(tokens: Token[], idx: number, options: MarkdownIt.Options, env:any, slf: Renderer) {
...
// eslint-disable-next-line
function renderFootnoteBlockOpen(tokens: Token[], idx: number, options: MarkdownIt.Options) {
...
function renderFootnoteOpen(tokens: Token[], idx: number, options: MarkdownIt.Options, env: any, slf: Renderer) {
...
function linkFoot(state: StateInline, silent: any) {
  let attrs,
    code,
    label,
    pos,
